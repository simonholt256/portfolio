...
function GrecianDB() {
  return (
    <>
      ...
      <div className="explore-text">The database would improved by images, and keywords to be links to other entity profiles. More work should be done on secrurity and scalability</div>
